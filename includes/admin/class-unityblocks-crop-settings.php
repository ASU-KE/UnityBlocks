...
class UnityBlocks_Crop_Settings {
	...
	/**
	 * Main UnityBlocks_Crop_Settings Instance.
	 *
	 * Insures that only one instance of UnityBlocks_Crop_Settings exists in memory at any one
	...
	public function hide_cropped_from_library( $query ) {
		...
		$tag = get_term_by( 'slug', 'unityblocks-cropped', 'post_tag' );
...
UnityBlocks_Crop_Settings::instance()->register_endpoints();
