...
class UnityBlocks_Accordion_IE_Support {
	 ...
	 *
	 * @var UnityBlocks_Accordion_IE_Support
	 */
	 ...
	 *
	 * @return UnityBlocks_Accordion_IE_Support
	 */
	public static function register() {
		if ( null === self::$instance ) {
			self::$instance = new UnityBlocks_Accordion_IE_Support();
		}
	...
	public function load_assets() {
		...
		if ( has_block( 'unityblocks/accordion' ) && "'true'" === $legacy_support ) {
...
UnityBlocks_Accordion_IE_Support::register();
