...
class UnityBlocks_Body_Classes {
	...
	public function themes() {
		...
		return apply_filters( 'unityblocks_theme_body_classes', $themes );
	}
	...
	public function body_class( $classes ) {
		...
		if ( apply_filters( 'unityblocks_is_amp', ( function_exists( 'is_amp_endpoint' ) && is_amp_endpoint() && ! in_array( 'amp', $classes, true ) ) ) ) {
			$classes[] = 'amp';
		}
