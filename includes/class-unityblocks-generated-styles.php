...
class UnityBlocks_Generated_Styles {
	 ...
	 *
	 * @var UnityBlocks_Generated_Styles
	 */
	 ...
	 *
	 * @return UnityBlocks_Generated_Styles
	 */
	public static function register() {
		if ( null === self::$instance ) {
			self::$instance = new UnityBlocks_Generated_Styles();
		}
	...
	public function enqueue_styles() {
		wp_add_inline_style( 'unityblocks-frontend', $this->styles() );
	}
	...
	public function styles() {
		...
		if ( $post && isset( $post->ID ) ) {
			...
			$meta    = get_post_meta( $post->ID, '_unityblocks_dimensions', true );
			$desktop = array();
			$tablet  = array();
			$mobile  = array();
			$output  = '';
			...
			$responsive_height = get_post_meta( $post->ID, '_unityblocks_responsive_height', true );
...
UnityBlocks_Generated_Styles::register();
