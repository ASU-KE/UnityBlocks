        ...
        >
          <div className="editor-post-featured-image">
              ...
              <MediaUpload
                ...
                render={({ open }) => (
                  <Button
                    ...
                    onClick={open}
                  >
                    {mediaId === 0 && __("Choose an image", "unityblocks")}
            ...
            {mediaId !== 0 && (
              <MediaUploadCheck>
                <MediaUpload
                  title={__("Replace image", "unityblocks")}
                  value={mediaId}
                  onSelect={onSelectMedia}
                  allowedTypes={["image"]}
                  render={({ open }) => (
        ...
        >
          <PanelRow>
            <TextControl
              ...
              placeholder="Text"
              value={quoteTitle}
              onChange={(quoteTitle) => setAttributes({ quoteTitle })}
            />
          </PanelRow>
          <PanelRow>
            <TextControl
          ...
          <PanelRow>
            <TextControl
              ...
              placeholder="Text"
              value={quoteCiteName}
              onChange={(quoteCiteName) => setAttributes({ quoteCiteName })}
            />
          </PanelRow>
          <PanelRow>
            <TextControl
        ...
        >
          ...
          <PanelRow>
            <TextControl
              ...
              placeholder="Not implemented"
              value={titleCssClass}
              onChange={(titleCssClass) => setAttributes({ titleCssClass })}
            />
          </PanelRow>
          <PanelRow>
            <TextControl
              ...
              onChange={(contentCssClass) => setAttributes({ contentCssClass })}
            />
          </PanelRow>
        </PanelBody>
      </InspectorControls>
