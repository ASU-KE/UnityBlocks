...
const save = ( props ) => {
	...
	const exampleCareers = { hide: exampleCareers__hide };
	...
	const nextSteps = { hide: nextSteps__hide };
	...
	return (
		<div
			...
			data-affordcollege={ affordingCollege__hide }
			data-flexdegreeoptions={ flexibleDegreeOptions__hide }
