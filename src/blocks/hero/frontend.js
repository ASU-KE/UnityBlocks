...
const image = hero?.dataset?.image ? JSON.parse( hero.dataset.image ) : {};
const subTitle = hero?.dataset?.subtitle
	? JSON.parse( hero.dataset.subtitle )
	: {};
const title = hero?.dataset?.title ? JSON.parse( hero.dataset.title ) : {};
const contents = hero?.dataset?.contents
	? JSON.parse( hero.dataset.contents )
	: [];
