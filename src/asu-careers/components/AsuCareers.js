  ...
  return (
    ...
    >
      ...
      {"user-choice" === editorListType && (
        ...
        >
          <div className={classNames("col-md-2", "col-12", "form-check")}>
            <input
              id="labelForStaff"
              type="radio"
              value="staff"
            ...
            <label
              ...
              className={classNames("form-check-label", "align-middle")}
            >
              {"Staff jobs"}
            </label>
          </div>
      ...
      {isError && <li>There has been a server error, please try again!</li>}
      ...
      {data && jobs?.length && (
        ...
        >
          <FontAwesomeIcon icon="fa-solid fa-user-tie" size="lg" inverse />
        </div>
      )}
            ...
            jobs.map((job) => (
              <li key={job.id} className="mb-6">
                <div className="single-job">
                  ...
                  <div className="mb-4">
                    <a target="_blank" rel="noreferrer" href={job.postingLink}>
                      Job details
                    </a>
                  </div>
                </div>
