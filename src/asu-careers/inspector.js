...
const Inspector = (props) => {
  ...
  const options = [
    ...
    {
      label: "College of Global Futures Staff",
      value: "College of Global Futures Staff",
    },
    {
    ...
    {
      label: "Ctr Innov Informal STEM Learn",
      value: "Ctr Innov Informal STEM Learn",
    },
    ...
    {
      label: "Just Energy Transition Center",
      value: "Just Energy Transition Center",
    },
    {
    ...
    {
      label: "KE Learning Engineering Inst",
      value: "KE Learning Engineering Inst",
    },
    ...
    {
      label: "School of Ocean Futures",
      value: "School of Ocean Futures",
    },
    {
    ...
    {
      label: "Science & Imagination Center",
      value: "Science & Imagination Center",
    },
