        ...
        <PanelBody title={__("Data Source", "unityblocks")} initialOpen={false}>
          ...
          {dataSourceType === "asuDrupal" && (
            <>
              <PanelRow>
                <TextControl
                  label={"Url"}
                  help={"Data source url requires the provided proxy."}
          ...
          {dataSourceType === "keGraphql" && (
            <>
              ...
              <PanelRow>
                <RadioControl
                  label={__("Events sort order", "unityblocks")}
                  selected={keSortEvents}
                  options={[
                    {
                      label: __("Ascending (older to newer)", "unityblocks"),
                      value: "ASC",
                    },
                    {
                      label: __("Descending (newer to older)", "unityblocks"),
                      value: "DESC",
                    },
                  ]}
                  onChange={(value) => setAttributes({ keSortEvents: value })}
                />
              </PanelRow>
            </>
          )}
