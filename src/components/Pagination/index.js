...
export const Pagination = ( {
	...
	// start small device
	const [ currentTotalNumbers, setCurrentTotalNumbers ] = useState(
		totalNumbers
	);
	...
	const renderPages = () => {
		...
		return (
			<>
				{ ! isSmallDevice && renderedPages[ 0 ] !== 1 && (
					<PageItem>...</PageItem>
				) }
				{ renderedPages.map(
					( page ) =>
...
Pagination.propTypes = {
	 ...
	 */
	background: PropTypes.oneOf( [ 'white', 'gray1', 'gray2', 'gray7' ] )
		.isRequired,
	/**
	 * Current page
	 */
