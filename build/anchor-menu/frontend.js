...
/***/ "./resources/unity/components-core/src/components/AnchorMenu/index.js":
/*!****************************************************************************!*\
  !*** ./resources/unity/components-core/src/components/AnchorMenu/index.js ***!
  \****************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AnchorMenu: function() { return /* binding */ AnchorMenu; }
/* harmony export */ });
...
/* harmony import */ var _core_hooks_use_media_query__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../core/hooks/use-media-query */ "./resources/unity/components-core/src/core/hooks/use-media-query.js");
/* harmony import */ var _core_services_googleAnalytics__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../core/services/googleAnalytics */ "./resources/unity/components-core/src/core/services/googleAnalytics.js");
/* harmony import */ var _core_utils_html_utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../core/utils/html-utils */ "./resources/unity/components-core/src/core/utils/html-utils.js");
/* harmony import */ var _Button__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../Button */ "./resources/unity/components-core/src/components/Button/index.js");
/* harmony import */ var _index_styles__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index.styles */ "./resources/unity/components-core/src/components/AnchorMenu/index.styles.js");
...
const AnchorMenu = ({
  ...
  const anchorMenuRef = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)(null);
  const [hasHeader, setHasHeader] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(false);
  const [actualContainer, setActualContainer] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
  const [showMenu, setShowMenu] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(false);
  const isSmallDevice = (0,_core_hooks_use_media_query__WEBPACK_IMPORTED_MODULE_3__.useMediaQuery)("(max-width: 991px)");
  const headerHeight = isSmallDevice ? 110 : 142;
  const handleWindowScroll = () => {
    const curPos = window.scrollY;
    // Select first next sibling element of the anchor menu
    const firstElement = document.getElementById(firstElementId)?.getBoundingClientRect().top;
    ...
    if (curPos > anchorMenuRef.current.getBoundingClientRect().top) anchorMenuRef.current.classList.add("sticky");

    // Change active containers on scroll
    let curSection = "";
    const subsHeight = hasHeader ? headerHeight + anchorMenuHeight : anchorMenuHeight;
    items?.forEach(({
      targetIdName
    }) => {
      const container = document.getElementById(targetIdName);
      const containerTop = container?.getBoundingClientRect().top - subsHeight;
      const containerBottom = container?.getBoundingClientRect().bottom - subsHeight;
  ...
  const setHeader = () => {
    const pageHeader = document.getElementById("asu-header") || document.getElementById("headerContainer") || document.getElementById("asuHeader");
  ...
  const handleClickLink = container => {
    ...
    let scrollTo = document.getElementById(container)?.getBoundingClientRect().top + curScroll;
    if (!anchorMenuRef.current.classList.contains("sticky")) scrollTo -= anchorMenuHeight;
    if (focusFirstFocusableElement) (0,_core_utils_html_utils__WEBPACK_IMPORTED_MODULE_5__.queryFirstFocusable)(`#${container}`)?.focus();
    window.scrollTo({
      top: scrollTo,
      behavior: "smooth"
    });
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_index_styles__WEBPACK_IMPORTED_MODULE_7__.AnchorMenuWrapper, {
    ref: anchorMenuRef,
    className: `uds-anchor-menu uds-anchor-menu-expanded-lg ${hasHeader ? "with-header " : ""}mb-4`,
    style: showMenu ? {
      borderBottom: 0
    } : {}
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "container-xl uds-anchor-menu-wrapper"
  }, isSmallDevice ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h4", null, menuTitle, ":", (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
    className: "fas fa-chevron-down"
  }))) : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h4", null, menuTitle, ":"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    "data-testid": "anchor-menu-container",
    id: "collapseAnchorMenu",
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()("card", "card-body", "collapse", {
      [`show`]: showMenu
    })
  ...
  // @ts-ignore
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Button__WEBPACK_IMPORTED_MODULE_6__.Button, {
    "data-testid": `anchor-item-${item.targetIdName}`,
    key: item.targetIdName,
    classes: ["nav-link", `${actualContainer === item.targetIdName ? "active" : ""}`],
    ariaLabel: item.text,
    label: item.text,
    icon: item.icon,
...
AnchorMenu.propTypes = {
  ...
  items: prop_types__WEBPACK_IMPORTED_MODULE_8___default().arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_8___default().shape({
    text: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().string).isRequired,
    targetIdName: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().string).isRequired,
    icon: prop_types__WEBPACK_IMPORTED_MODULE_8___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_8___default().string))
  })).isRequired,
  /**
   * First next sibling element of the anchor menu
   */
  firstElementId: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().string).isRequired,
  /**
   * If true it focus the first focusable element into the section
   * If false it focus the next menu item into the nav bar
   */
  focusFirstFocusableElement: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().bool)
};

/***/ }),

/***/ "./resources/unity/components-core/src/components/AnchorMenu/index.styles.js":
/*!***********************************************************************************!*\
  !*** ./resources/unity/components-core/src/components/AnchorMenu/index.styles.js ***!
  \***********************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AnchorMenuWrapper: function() { return /* binding */ AnchorMenuWrapper; }
/* harmony export */ });
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! styled-components */ "./node_modules/styled-components/dist/styled-components.browser.esm.js");

const AnchorMenuWrapper = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].div`
  &.sticky {
    position: fixed;
    top: 0;
    left: 0;
...
/***/ "./resources/unity/components-core/src/components/Button/index.js":
/*!************************************************************************!*\
  !*** ./resources/unity/components-core/src/components/Button/index.js ***!
  \************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _core_services_googleAnalytics__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../core/services/googleAnalytics */ "./resources/unity/components-core/src/core/services/googleAnalytics.js");
...
const Button = ({
  ...
  const btnClasses = classnames__WEBPACK_IMPORTED_MODULE_1___default()("btn", {
    [`btn-${color}`]: true,
    [`btn-md`]: size === "small",
    [`btn-sm`]: size === "xsmall",
    [`btn-block`]: block,
  ...
  const handleClick = text => {
    (0,_core_services_googleAnalytics__WEBPACK_IMPORTED_MODULE_3__.trackGAEvent)({
      ...gaDefaultObject,
      text
    });
    onClick?.();
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Tag, {
    ...
    ...props,
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()(classes) || btnClasses,
    href: href,
    ref: innerRef,
    ...
    className: `${icon?.[0]} fa-${icon?.[1]} mr-1`
  }), label);
};
Button.propTypes = {
  /**
  ...
  */
  ariaLabel: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().string),
  /**
    Render button as a block-button?
  */
  block: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().bool),
  /**
    Button background color
  */
  color: prop_types__WEBPACK_IMPORTED_MODULE_4___default().oneOf(["gold", "maroon", "gray", "dark"]),
  /**
    Disable the button?
  */
  ...
  */
  element: prop_types__WEBPACK_IMPORTED_MODULE_4___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_4___default().func), (prop_types__WEBPACK_IMPORTED_MODULE_4___default().string), prop_types__WEBPACK_IMPORTED_MODULE_4___default().shape({
    $$typeof: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().symbol),
    render: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().func)
  }), prop_types__WEBPACK_IMPORTED_MODULE_4___default().arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_4___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_4___default().func), (prop_types__WEBPACK_IMPORTED_MODULE_4___default().string), prop_types__WEBPACK_IMPORTED_MODULE_4___default().shape({
    $$typeof: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().symbol),
    render: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().func)
  })]))]),
  /**
  ...
  */
  icon: prop_types__WEBPACK_IMPORTED_MODULE_4___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_4___default().string)),
  /**
  ...
  */
  ...
  /**
    Button size
  */
  size: prop_types__WEBPACK_IMPORTED_MODULE_4___default().oneOf(["default", "small", "xsmall"]),
  /**
    Classes to add to button
  */
  classes: prop_types__WEBPACK_IMPORTED_MODULE_4___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_4___default().string)),
  /**
   Link target type
   */
  target: prop_types__WEBPACK_IMPORTED_MODULE_4___default().oneOf(["_blank", "_self", "_top", "_parent"])
};
Button.defaultProps = {
  label: "",
  ariaLabel: undefined,
...
/***/ "./resources/unity/components-core/src/core/hooks/use-media-query.js":
/*!***************************************************************************!*\
  !*** ./resources/unity/components-core/src/core/hooks/use-media-query.js ***!
  \***************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./resources/unity/components-core/src/core/services/googleAnalytics.js":
/*!******************************************************************************!*\
  !*** ./resources/unity/components-core/src/core/services/googleAnalytics.js ***!
  \******************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   trackGAEvent: function() { return /* binding */ trackGAEvent; }
/* harmony export */ });
/**
 * @param {{
 *  event?: string
...
/***/ "./resources/unity/components-core/src/core/utils/html-utils.js":
/*!**********************************************************************!*\
  !*** ./resources/unity/components-core/src/core/utils/html-utils.js ***!
  \**********************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   queryFirstFocusable: function() { return /* binding */ queryFirstFocusable; },
/* harmony export */   sanitizeDangerousMarkup: function() { return /* binding */ sanitizeDangerousMarkup; }
/* harmony export */ });
...
const sanitizeDangerousMarkup = content => {
  return {
    __html: (0,dompurify__WEBPACK_IMPORTED_MODULE_0__.sanitize)(content)
  };
};
...
"use strict";
/*!*************************************!*\
  !*** ./src/anchor-menu/frontend.js ***!
  \*************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _resources_unity_components_core_src_components_AnchorMenu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../resources/unity/components-core/src/components/AnchorMenu */ "./resources/unity/components-core/src/components/AnchorMenu/index.js");
...
render((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_resources_unity_components_core_src_components_AnchorMenu__WEBPACK_IMPORTED_MODULE_1__.AnchorMenu, {
  items: items,
