...
These are a collection of scripts used to assist during development and/or deployment of UnityBlocks.
...
This script will setup a local install of a specific version of WordPress (defined by `[wordpress-version]`), install UnityBlocks and run our end-to-end testing suite against it. A list of Cypress specs can be passed as the first parameter or an empty string will run all specs.
