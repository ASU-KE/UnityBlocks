...
import { sanitizeDangerousMarkup } from '@asu-design-system/components-core/dist/libCore.es';
				...
				<Formik
					...
					onSubmit={ (
						...
						setTimeout( () => {
							...
							// Advance the step.
							next();
							Object.keys( initialValues[ step + 1 ] ).map(
								( key ) => setFieldTouched( key, false, false )
							);
						}, 400 );
					} }
				>
