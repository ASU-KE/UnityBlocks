...
export interface DrupalFeedContainerProviderProps {
...
export const DrupalFeedContainerProvider: React.FunctionComponent< DrupalFeedContainerProviderProps >;
...
export function sanitizeDangerousMarkup(
	content: string
):
	| {
			__html: string;
