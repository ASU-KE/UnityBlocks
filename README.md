...
## Known Issues
* __Anchor Menu__ - Positioning behavior is depends on Unity React Header. Some additional positioning rules may be needed upstream component. Doesn't adapt postioning to WP Admin Bar. Overriding encapsulated component styles is challenging. We will probably need to submit some WP-specific rules to the Unity React component.
...
* __Hero__ - Content format settings, such as max width and color highlighting do not appear to be implemented in the React component yet.
